# Process Documentation for Multiclass Classification of Pet Breeds
...
- **Learning Rate: 0.01**
  - **Epochs:** 10
  - **Training Loss:** 3.1376
  - **Training Accuracy:** 0.1180
  - **Validation Loss:** 3.1836
  - **Validation Accuracy:** 0.1241

- **Learning Rate: 0.001**
  - **Epochs:** 10
  - **Training Loss:** 1.8657
  - **Training Accuracy:** 0.4410
  - **Validation Loss:** 2.5026
...
### 3rd Trial (Custom Model - ResNet50)
...
### 4th Trial (Custom Model - ResNet34)
